...
ax.set_axis_off()
#ax.set_title("Number of Dwellings by Postal Code Area (Helsinki, 2023)", fontsize=14)

plt.show()

# Save
#fig.savefig("Pictures/Postal_code/dwellings_q.png", dpi=600, bbox_inches="tight")