...
# 2. QUERY
# ---------------------------
url = "https://pxdata.stat.fi/PxWeb/api/v1/en/Postinumeroalueittainen_avoin_tieto/arkisto/2025/paavo_pxt_12ey.px"
...
ax.set_axis_off()
#ax.set_title("Population by Postal Code Area (Helsinki, 2023)", fontsize=14)

plt.show()

# Save
#fig.savefig("Pictures/Postal_code/population_ei.png", dpi=600, bbox_inches="tight")